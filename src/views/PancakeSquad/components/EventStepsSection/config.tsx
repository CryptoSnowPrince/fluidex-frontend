  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Sherpaswap Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold YAK'),
      bodyText: [t('Each NFT costs YAK to mint. Remember you also need SEI to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
