...
import { YAK_BNB_LP_MAINNET } from './farms'
import { Ifo } from './types'

export const cakeBnbLpToken = new Token(ChainId.BSC, YAK_BNB_LP_MAINNET, 18, 'YAK-SEI LP')
...
const ifos: Ifo[] = [
  {
    ...
    description:
      'Meta Apes is a free-to-play, play-and-earn massively multiplayer online (MMO) strategy game designed for mobile and the first game to launch on the SEI Sidechain with their own dedicated chain, Ape Chain.',
